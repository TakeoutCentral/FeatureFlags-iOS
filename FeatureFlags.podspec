...
Pod::Spec.new do |s|
  s.name             = 'FeatureFlags'
  s.version          = '0.1.0'
  s.summary          = 'A short description of FeatureFlags.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mgray88/FeatureFlags'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mgray88' => 'mgray88@gmail.com' }
  s.source           = { :git => 'https://github.com/mgray88/FeatureFlags.git', :tag => s.version.to_s }
